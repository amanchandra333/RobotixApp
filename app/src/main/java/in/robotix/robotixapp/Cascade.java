...
public class Cascade extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cascade_complete);
		...
		website.setOnClickListener(new OnClickListener() {
	           ...
	           public void onClick(View view) {
	        	...
	        	Intent website= new Intent();
	   	        website.setAction(Intent.ACTION_VIEW);
	   	        website.addCategory(Intent.CATEGORY_BROWSABLE);
	   	        website.setData(Uri.parse("http://www.robotix.in/events/event/cascade"));
	   	        startActivity(website);
	           }
	       });
		pdfl.setOnClickListener(new OnClickListener() {
	           ...
	           public void onClick(View view) {
	        	...
	        	Intent website= new Intent();
	   	        website.setAction(Intent.ACTION_VIEW);
	   	        website.addCategory(Intent.CATEGORY_BROWSABLE);
	   	        website.setData(Uri.parse("http://robotix.in/PDF/finalevent_cascade.pdf"));
	   	        startActivity(website);
	           }
	       });
